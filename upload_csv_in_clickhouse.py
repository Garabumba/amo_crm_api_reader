...
def import_data(db_name, table_name, csv_path, username, password, host, port):
    command = f"""
    clickhouse-client --user={username} --password={password} --host={host} --port={port} \
...
if __name__ == '__main__':
    ...
    for table_name in table_names:
        ...
        try:
            import_data(db_name, table_name, file_path, username, password, host, local_port)
